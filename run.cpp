...
void run::parse_line(int line_num){
...
int run::string_convert(std::string& input_line){
    //判断语句是否有行号
...
void run::store_line_number(int line_num){
...
QString run::print_line(int line_num){
...
void run::store_expreesions(int line_num){
...
Statement run::get_state_op(int &line_index){
...
void run::run_program(int &line_index){
...
void run::run_let(int &line_index){
...
void run::run_print(int &line_index){
    int cur_line_num = line_numbers[line_index];
